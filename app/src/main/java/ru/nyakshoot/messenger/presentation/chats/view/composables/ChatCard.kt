...
@Composable
fun ChatCard(chatTitle: String, lastMessage: Message, currentUser: AuthUser, onClick: () -> Unit) {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .height(100.dp)
        ...
        Column(
            ...
            Row(
                ...
                Column(
                    ...
                    if (currentUser.id == lastMessage.senderId)
                        Text(
                            text = "Вы: ${lastMessage.text}",
                            maxLines = 1,
                            overflow = TextOverflow.Ellipsis
                        )
                    else
                        Text(
                            text = "$chatTitle: ${lastMessage.text}",
                            maxLines = 1,
                            overflow = TextOverflow.Ellipsis
                        )
                }
